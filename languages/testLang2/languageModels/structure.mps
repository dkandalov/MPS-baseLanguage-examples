...
<model modelUID="r:375b3f7e-82a7-4754-bcb9-c8b5a1dd7d4b(unitTest2.structure)">
  ...
  <refactoringHistory>
    <refactoringContext modelVersion="0">
      ...
      <conceptFeatureMap>
        <entry>
          <key featureName="ListLiteral" conceptFQName="testLang2.structure.ListLiteral" featureKind="CONCEPT" />
          <value featureName="SequenceLiteral" conceptFQName="testLang2.structure.SequenceLiteral" featureKind="CONCEPT" />
        </entry>
      </conceptFeatureMap>
    </refactoringContext>
    <refactoringContext modelVersion="1">
      ...
      <conceptFeatureMap>
        <entry>
          <key featureName="AssertList" conceptFQName="testLang2.structure.AssertList" featureKind="CONCEPT" />
          <value featureName="AssertList" conceptFQName="unitTest2.structure.AssertList" featureKind="CONCEPT" />
        </entry>
        <entry>
          <key featureName="AssertSequence" conceptFQName="testLang2.structure.AssertSequence" featureKind="CONCEPT" />
          <value featureName="AssertSequence" conceptFQName="unitTest2.structure.AssertSequence" featureKind="CONCEPT" />
        </entry>
        <entry>
          <key featureName="SequenceLiteral" conceptFQName="testLang2.structure.SequenceLiteral" featureKind="CONCEPT" />
          <value featureName="SequenceLiteral" conceptFQName="unitTest2.structure.SequenceLiteral" featureKind="CONCEPT" />
        </entry>
        <entry>
          <key featureName="ShouldBe" conceptFQName="testLang2.structure.ShouldBe" featureKind="CONCEPT" />
          <value featureName="ShouldBe" conceptFQName="unitTest2.structure.ShouldBe" featureKind="CONCEPT" />
        </entry>
      </conceptFeatureMap>
    </refactoringContext>
  ...
  <node type="jetbrains.mps.lang.structure.structure.ConceptDeclaration" id="8793372375416262010">
    ...
    <node role="linkDeclaration" type="jetbrains.mps.lang.structure.structure.LinkDeclaration" id="8793372375416466798">
      <property name="metaClass" value="aggregation" />
  ...
  <node type="jetbrains.mps.lang.structure.structure.ConceptDeclaration" id="6638220681317433308">
    ...
    <link role="extends" targetNodeId="2.1068580123157" resolveInfo="Statement" />
    <node role="conceptProperty" type="jetbrains.mps.lang.structure.structure.StringConceptProperty" id="6638220681317464619">
      <property name="value" value="assert sequence" />
      <link role="conceptPropertyDeclaration" targetNodeId="2v.1137473891462" resolveInfo="alias" />
    </node>
    <node role="linkDeclaration" type="jetbrains.mps.lang.structure.structure.LinkDeclaration" id="6638220681317433554">
      <property name="metaClass" value="aggregation" />
      <property name="role" value="actual" />
      <property name="sourceCardinality" value="1" />
      <link role="target" targetNodeId="2.1068431790191" resolveInfo="Expression" />
    </node>
    <node role="linkDeclaration" type="jetbrains.mps.lang.structure.structure.LinkDeclaration" id="6638220681317433800">
      <property name="metaClass" value="aggregation" />
      <property name="role" value="elementType" />
      <property name="sourceCardinality" value="1" />
      <link role="target" targetNodeId="2.1068431790189" resolveInfo="Type" />
    </node>
    <node role="linkDeclaration" type="jetbrains.mps.lang.structure.structure.LinkDeclaration" id="6638220681317433801">
      <property name="metaClass" value="aggregation" />
  ...
  <node type="jetbrains.mps.lang.structure.structure.ConceptDeclaration" id="93703267107417638">
    <property name="name" value="SequenceLiteral" />
    <link role="extends" targetNodeId="2.1068431790191" resolveInfo="Expression" />
    <node role="linkDeclaration" type="jetbrains.mps.lang.structure.structure.LinkDeclaration" id="93703267107417643">
      <property name="metaClass" value="aggregation" />
      <property name="sourceCardinality" value="0..n" />
      <property name="role" value="initValue" />
      <link role="target" targetNodeId="2.1068431790191" resolveInfo="Expression" />
    </node>
    <node role="conceptProperty" type="jetbrains.mps.lang.structure.structure.StringConceptProperty" id="93703267107417662">
      <property name="value" value="[]" />
      <link role="conceptPropertyDeclaration" targetNodeId="2v.1137473891462" resolveInfo="alias" />
    </node>
    <node role="conceptProperty" type="jetbrains.mps.lang.structure.structure.StringConceptProperty" id="93703267107781034">
      <property name="value" value="create linkedlist" />
      <link role="conceptPropertyDeclaration" targetNodeId="2v.1137473914776" resolveInfo="shortDescription" />
    </node>
    <node role="conceptProperty" type="jetbrains.mps.lang.structure.structure.BooleanConceptProperty" id="93703267108563521">
  ...
  <node type="jetbrains.mps.lang.structure.structure.ConceptDeclaration" id="6478881869179173977">
    ...
    <node role="conceptProperty" type="jetbrains.mps.lang.structure.structure.StringConceptProperty" id="6478881869179174254">
      <property name="value" value="should be" />
      <link role="conceptPropertyDeclaration" targetNodeId="2v.1137473914776" resolveInfo="shortDescription" />
    </node>
  </node>
